    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        let specialty_names_str = result.jobs[i].specialty_names;
          ...
          var hotJobElement = hotJob === true ? '<div id="hotJob"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b92927905d052de6d4e_Hot%20job.svg"><span>Hot Job</span><span class="tooltip">If you not able to find job, contact as at <a href="mailto:hello@directshifts.com">hello@directshifts.com</a></span></div>' : '';
   ...
   //Search jobs
    jQuery(document).on("click", "datalist input", function () {
        ...
        if(jQuery(this).hasClass('api-occupation')){
            ...
            $( "ul.search_fields li:nth-child(2)").find("div.card-header").delay(200).trigger("click");
