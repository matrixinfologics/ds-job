    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        if (!document.getElementById("lists_occupation")) {
            ...
            occupations_html += `<label><input type="checkbox" class="api-occupation" name="occupations" value="${uniqueOccupations[j]}">${uniqueOccupations[j]}</label>`;
            }
...
//   Search jobs
    ...
    jQuery("#clear-all-button").on("click", function () {
        ...
        let a = new URL("https://www.directshifts.com/a-job-listing-copy-2023-oct-19");
