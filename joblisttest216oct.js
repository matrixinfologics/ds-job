                  ...
                  if ("" != e.jobs) {
                      for (let a = 0; a < e.jobs.length; a++) {
                         ...
                         (t += `<tr class="my-code">\n   <td> <div class="jl-title-wrap">\n   <div class="jl-title"><a target="_blank" class="data-link" href="${e.jobs[a].link}">${
                              ...
                              e.jobs[a].state_code
                          }</span></div><div class="jl-location"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/63c1428ec77fbc6cb91ce1c7_location-icon.png"/><span>${e.jobs[a].shift_type}, Shift</span> </div></div></div><div class="apply-now-wrap">` + 
