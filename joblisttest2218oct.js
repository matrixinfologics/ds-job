    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        let specialty_names_str = result.jobs[i].specialty_names;
          ...
          let practice_type_strr = `<div class="jl-location tagPracticType"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b97cd50b343566cede6_Practice%20type.svg"/><span><span class="jl-pt-inr-items">${result.jobs[i].practice_type}</span></span></div>`;
          ...
          html += `<tr>
            <td>
                ...
                ${typeof result.jobs[i].practice_type === "string" ? practice_type_strr : practice_type_html}
                </div>
                </div>
