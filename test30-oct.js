jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        var getUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="btn-applynow" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=${utmMedium}&utm_campaign=${utmCampaign}">Apply Now</a>` : `<a target="_blank" class="btn-applynow" href="${result.jobs[i].link}">Apply Now</a>`;
        var checkBotton = utmMedium && utmCampaign == "" ? `<a target="_blank" class="btn-applynow cus_utm_add" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=A-job-Listing-Copy-30-oct&utm_campaign=Apply-Now">Apply Now</a>` : getUtmVal;
   ...
   //Search jobs
    jQuery(document).on("click", "datalist input", function () {
        ...
        if(jQuery(this).hasClass('api-occupation')){
            ...
            r = new URL("https://www.directshifts.com/a-job-listing-copy-30-oct");
    ...
    jQuery("#clear-all-button").on("click", function () {
        ...
        let a = new URL("https://www.directshifts.com/a-job-listing-copy-30-oct");
