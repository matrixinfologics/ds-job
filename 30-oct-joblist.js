      ...
      success: function (result) {
        ...
        let specialty_names_str = result.jobs[i].specialty_names;
          ...
          var utmCampaign = getParameterByName('utm_campaign');
            ...
            // } else {
            //     // If UTM parameters are not found, use the default URL
            //     let linkD = result.jobs[i].link;
            //     console.log('Link:', linkD);
            // }
            var getUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="btn-applynow" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_campaign=${utmSource}?utm_medium=${utmMedium}?utm_campaign=${utmCampaign}">Apply Now</a>` : `<a target="_blank" class="btn-applynow" href="${result.jobs[i].link}">Apply Now</a>`;
