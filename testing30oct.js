jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        var getUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="btn-applynow" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=${checkMedium}&utm_campaign=${checkCampaign}">Apply Now</a>` : `<a target="_blank" class="btn-applynow" href="${result.jobs[i].link}">Apply Now</a>`;
