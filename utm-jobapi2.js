jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        var titleUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="data-link" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=${utmMedium}&utm_campaign=${utmCampaign}">${result.jobs[i].title}</a>` : `<a target="_blank" class="data-link" href="${result.jobs[i].link}">${result.jobs[i].title}</a>`;
        html += `<tr>
            <td>
                ${hotJobElement}
