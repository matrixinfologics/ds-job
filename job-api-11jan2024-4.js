    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        jQuery('input[type="radio"]').on('click', function () {
            let value = jQuery(this).val(); // Get the value of the clicked radio button
    
            if (value === "Physician (MD/DO)") {
                if (i === 4) {
                    html += `<tr class="desktopSign cstom1 mobile-apps-1">Physician (MD/DO) DATA</tr>`;
                }
                if (i === 10) {
                    html += `<tr class="desktopSign cstom2 mobile-apps download-app">Physician (MD/DO) DATA</tr>`;
                }
                console.log("Physician (MD/DO) clicked");
            } else if (value === "Physician Assistant (PA)") {
                if (i === 4) {
                    html += `<tr class="desktopSign cstom1 mobile-apps-1">Physician Assistant (PA)</tr>`;
                }
                if (i === 10) {
                    html += `<tr class="desktopSign cstom2 mobile-apps download-app">Physician Assistant (PA)</tr>`;
                }
                console.log("Physician Assistant (PA) clicked");
            }
        });
