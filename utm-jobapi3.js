jQuery(document).ready(function () {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        var hotJobElement = hotJob === true ? '<div id="hotJob"><div class="ht-inner"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b92927905d052de6d4e_Hot%20job.svg" width="18px" height="18px"><span class="hot-job-txt">Hot Job</span><span class="tooltip">Our newest and fast-filling opportunities</span></div></div>' : '';
        ...
        var modifiedTitle = originalTitle.replace(/ /g, '-');
        var getUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="btn-applynow" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=${utmMedium}&utm_campaign=${utmCampaign}&utm_content=${utmContent}">Apply Now</a>` : `<a target="_blank" class="btn-applynow" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=mkt-website&utm_medium=Open-Jobs&utm_campaign=Apply-Now&utm_content=${utmContentDate}">Apply Now</a>`;
        var titleUtmVal = utmSource && utmMedium && utmCampaign ? `<a target="_blank" class="data-link" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=${utmSource}&utm_medium=${utmMedium}&utm_campaign=${utmCampaign}&utm_content=${utmContent}">${result.jobs[i].title}</a>` : `<a target="_blank" class="data-link" href="https://app.directshifts.com/jobs/p/${result.jobs[i].slug}?utm_source=mkt-website&utm_medium=Open-Jobs&utm_campaign=${modifiedTitle}&utm_content=${utmContentDate}">${result.jobs[i].title}</a>`;
        html += `<tr>
            <td>
                ${hotJobElement}
                ...
                <div class="shareBtn">
                    <div class="share_box">
                        <img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b992fcd0945fc55e4c4_Share.svg" width="24px" height="24px"/>
        ...
        if (i === 4){ html += `<tr class="desktopSign cstom1 mobile-apps-1"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f538c315ff9443fa72_Sign%20Up%20Banner%20(1).svg" alt="image" width="237px" height="237px"></div><div class="right-content"><div class="directshift_regstring"><h4>Make the most of DirectShifts by registering for free!</h4><div class="dirctneq"><ul><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1b3935fbb351447b5_Personalised%20recommendations.svg" width="26px" height="26px"><span>Personalised recommendations</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f18c8705e97403803c_Get%20support%20at%20every%20step.svg" width="26px" height="26px"><span>Get support at every step</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1e4171f39a0ede315_Boost%20visibility%20with%20employers%20.svg" width="26px" height="26px"><span>Real-time updates</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f27031cb2307405bbf_Real-time%20updates.svg" width="26px" height="26px"><span>Boost visibility with employers</span></li></ul></div><div class="dirctregstrbtn"><a href="https://www.directshifts.com/sign-up?utm_source=mkt-website&utm_medium=Open-Jobs&utm_campaign=Sign-Up&utm_content=${utmContentDate}">Sign Up</a></div></div></div></div></td></tr>`; }
        if (i === 10){ html += `<tr class="desktopSign cstom2 mobile-apps download-app"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653222e09e96e3d3c8cd0db8_ad-2-mockup-img.png" alt="image" width="180px" height="213px"></div><div class="right-content"><div class="directshift_regstring"><h4>Find your perfect healthcare job on the go with the DirectShifts App!</h4><div class="dirctneq"><ul class="app-list"><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab079dbdf6f28bf20e_Application%20tracking.svg" width="26px" height="26px"><span>Application Tracking</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51abbb28af1d85a86ff7_Document%20mang.svg" width="26px" height="26px"><span>Document Management</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab32389852cbc7d0f8_Timesheet%20(1).svg" width="26px" height="26px"><span>Seamless Timesheets</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51aba889c0a4dfba6ddb_Paycheck.svg" width="26px" height="26px"><span>Paycheck Tracking</span></li></ul></div><div class="dirctregstrbtn download"><a href="https://www.directshifts.com/directshifts-mobile-app?utm_source=mkt-website&utm_medium=Open-Jobs&utm_campaign=Download-Now&utm_content=${utmContentDate}">Download Now</a></div></div></div></div></td></tr>`; }
