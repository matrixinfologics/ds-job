...
if (queryString) {
  ...
  if (occupation !== false) {
    ...
    occupation_ar = encodeURIComponent(occupation.replace(/\+/g, " "));
  }

  var specialty = getUrlParameter("specialty[]");
  if (specialty !== false) {
    specialty_ar = specialty.split(",");
    specialty_ar = specialty_ar.map(function (value) {
  ...
  if (state !== false) {
    ...
    state_ar = state_ar.map(function (value) {
      return decodeURIComponent(value.replace(/\+/g, " "));
    });
  }
  ...
  if (practice_type !== false) {
    ...
    practice_type_ar = practice_type_ar.map(function (value) {
      return decodeURIComponent(value.replace(/\+/g, " "));
    });
  }
  ...
  if (category !== false) {
    ...
    category_ar = category_ar.map(function (value) {
      return decodeURIComponent(value.replace(/\+/g, " "));
    });
  }
