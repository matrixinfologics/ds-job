                ...
                success: function (e) {
                    ...
                    if ("" != e.jobs) {
                        for (let a = 0; a < e.jobs.length; a++) {
                            ...
                            var getFromWindow = urlParams.get('utm_source');
                            (t += `<tr class="my-code">\n   <td> <div class="jl-title-wrap">\n   <div class="jl-title"><a target="_blank" class="data-link" href="${e.jobs[a].link}">${
                                ...
                                e.jobs[a].slug
                            }?utm_source=${getFromWindow}">Test Button</a><a target="_blank" class="btn-applynow" href="${e.jobs[a].link}">Apply Now</a></div></div>\n   <div class="jl-types"> <a target="_blank" class="data-link"href="${
                                e.jobs[a].link
                                ...
                                4 === a &&
                                    (t +=
                                        '<tr class="desktopSign cstom1"><td colspan="2"><div class="directshift_regstring"><h4>Make the most of Directshifts by registering for free</h4><div class="dirctneq"><ul><li>Personalised recommendations</li><li>Get support at every step</li><li>Real-time updates</li><li>Boost visibility with employers</li></ul></div><div class="dirctregstrbtn"><a href="/sign-up">Register Now</a></div></div></td></tr>'),
                                10 === a &&
                                    (t +=
                                        '<tr class="desktopSign cstom2"><td colspan="2"><div class="directshift_drmhlth"><p>Download the DirectShifts mobile app and stay up-to-date on the newest job opportunities, anytime, anywhere.</p><div class="drctgetinbtn"><div class="drctgetinbtninnr innr1"><ul><li class="drctgplay"><a href="https://play.google.com/store/apps/details?id=com.directshifts&hl=en_US&gl=US" target="_blank"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/62ebcbb9a2b05a280e438f48_g-.png" class="img-fluid" alt="" /></a></li><li class="drctapstr"><a href="https://apps.apple.com/us/app/directshifts/id1420001050" target="_blank"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/62e10a5b5da41e77eb18df78_app_store_badge.png" class="img-fluid" alt="" /></a></li></ul></div><div class="drctgetinbtninnr innr2"><div class="brscnr"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/645a369b68f25b7e706a52ae_qr-code-p-500.png" class="img-fluid" alt="" /></div></div></div></div></td></tr>');
                        }
                        let a = "";
                        e.total_pages > 1 &&
                            (a =
