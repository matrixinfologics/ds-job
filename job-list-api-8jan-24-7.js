...
//   Call function when page loads
  ...
  if(queryString){
    ...
    if (occupation !== false) {
         //occupation_ar = occupation.split(",");
         //occupation_ar = occupation_ar.map(function(value){ return value.replace(/\+/g," "); })
        occupation_ar = occupation.replace(/\+/g," ").replace(/occupation%5B0%5D=([^&]*)/, 'occupation%5B%5D=$1');
        alert(occupation_ar);
    }
    ...
    if(state != false){
        ...
        state_ar = state_ar.map(function(value){ return value.replace(/\+/g," ").replace(/state%5B0%5D=([^&]*)/, 'state%5B%5D=$1'); })
    }
