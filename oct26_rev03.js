    ...
    jQuery(document).on("click", "datalist input", function () {
        ...
        let t = getSelectedValues(".api-state:checked"),
            ...
            c = getSelectedValues(".api-practice-type:checked");
                ...
                t && cst.searchParams.set("state", t),
                s && cst.searchParams.set("city", s),
                i && cst.searchParams.set("occupation", i),
                n && cst.searchParams.set("specialty", n),
                l && cst.searchParams.set("category", l),
                c && cst.searchParams.set("practice_type", c);
                alert(cst.toString());
