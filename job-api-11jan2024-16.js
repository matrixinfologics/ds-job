    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        html += `<tr>
            ...
            function occGetUrlParameter(name) {
              name = name.replace(/[\[]/, '\\[').replace(/[\]]/, '\\]');
              var regex = new RegExp('[\\?&]' + name + '=([^&#]*)');
              var results = regex.exec(location.search);
              return results === null ? '' : decodeURIComponent(results[1].replace(/\+/g, ' '));
            }
            var occupationValue = occGetUrlParameter('occupation%5B%5D');
            if (occupationValue === 'Physician (MD/DO)') {
                if (i === 4){ html += `<tr class="desktopSign cstom1 mobile-apps-1"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f538c315ff9443fa72_Sign%20Up%20Banner%20(1).svg" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Physician (MD/DO)</h4><div class="dirctneq"><ul><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1b3935fbb351447b5_Personalised%20recommendations.svg"><span>Personalised recommendations</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f18c8705e97403803c_Get%20support%20at%20every%20step.svg"><span>Get support at every step</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1e4171f39a0ede315_Boost%20visibility%20with%20employers%20.svg"><span>Real-time updates</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f27031cb2307405bbf_Real-time%20updates.svg"><span>Boost visibility with employers</span></li></ul></div><div class="dirctregstrbtn"><a href="https://www.directshifts.com/sign-up?utm_source=${getUtmScr}&utm_medium=${getMktPageTitle}&utm_campaign=${getMktSignBtn}&utm_content=${getNewUtmCon}">Sign Up</a></div></div></div></div></td></tr>`; }
                if (i === 10){ html += `<tr class="desktopSign cstom2 mobile-apps download-app"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653222e09e96e3d3c8cd0db8_ad-2-mockup-img.png" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Physician (MD/DO)</h4><div class="dirctneq"><ul class="app-list"><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab079dbdf6f28bf20e_Application%20tracking.svg"><span>Application Tracking</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51abbb28af1d85a86ff7_Document%20mang.svg"><span>Document Management</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab32389852cbc7d0f8_Timesheet%20(1).svg"><span>Seamless Timesheets</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51aba889c0a4dfba6ddb_Paycheck.svg"><span>Paycheck Tracking</span></li></ul></div><div class="dirctregstrbtn download"><a href="https://www.directshifts.com/directshifts-mobile-app?utm_source=${getUtmScr}&utm_medium=${getMktPageTitle}&utm_campaign=${getMktDownBtn}&utm_content=${getNewUtmCon}">Download Now</a></div></div></div></div></td></tr>`; }  
            } 
            else if (occupationValue === 'Advanced Practice Registered Nurse (APRN, NP, CNS, Midwife, etc.)') {
                if (i === 4){ html += `<tr class="desktopSign cstom1 mobile-apps-1"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f538c315ff9443fa72_Sign%20Up%20Banner%20(1).svg" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Advanced Practice Registered Nurse (APRN, NP, CNS, Midwife, etc.)</h4><div class="dirctneq"><ul><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1b3935fbb351447b5_Personalised%20recommendations.svg"><span>Personalised recommendations</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f18c8705e97403803c_Get%20support%20at%20every%20step.svg"><span>Get support at every step</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f1e4171f39a0ede315_Boost%20visibility%20with%20employers%20.svg"><span>Real-time updates</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f27031cb2307405bbf_Real-time%20updates.svg"><span>Boost visibility with employers</span></li></ul></div><div class="dirctregstrbtn"><a href="https://www.directshifts.com/sign-up?utm_source=${getUtmScr}&utm_medium=${getMktPageTitle}&utm_campaign=${getMktSignBtn}&utm_content=${getNewUtmCon}">Sign Up</a></div></div></div></div></td></tr>`; }
                if (i === 10){ html += `<tr class="desktopSign cstom2 mobile-apps download-app"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653222e09e96e3d3c8cd0db8_ad-2-mockup-img.png" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Advanced Practice Registered Nurse (APRN, NP, CNS, Midwife, etc.)</h4><div class="dirctneq"><ul class="app-list"><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab079dbdf6f28bf20e_Application%20tracking.svg"><span>Application Tracking</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51abbb28af1d85a86ff7_Document%20mang.svg"><span>Document Management</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51ab32389852cbc7d0f8_Timesheet%20(1).svg"><span>Seamless Timesheets</span></li><li><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/653a51aba889c0a4dfba6ddb_Paycheck.svg"><span>Paycheck Tracking</span></li></ul></div><div class="dirctregstrbtn download"><a href="https://www.directshifts.com/directshifts-mobile-app?utm_source=${getUtmScr}&utm_medium=${getMktPageTitle}&utm_campaign=${getMktDownBtn}&utm_content=${getNewUtmCon}">Download Now</a></div></div></div></div></td></tr>`; }  
            } 
            else {
              //var additionalHtml = '';
   ...
   //Search jobs
    jQuery(document).on("click", "datalist input", function () {
        ...
        if(jQuery(this).hasClass('api-occupation')){
            ...
            r = new URL("https://www.directshifts.com/open-jobs-11-jan");
    ...
    jQuery("#clear-all-button").on("click", function () {
        ...
        let a = new URL("https://www.directshifts.com/open-jobs-11-jan");
