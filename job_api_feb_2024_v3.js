    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        if(result.jobs.length <= 3){ jQuery('.sidebtmlft').addClass('notFoundResult'); }
            ...
            var nFgetUtmVal = utmSource && utmMedium && utmCampaign ? `<a class="utm-btn-val-nf" href="https://www.directshifts.com/speak-to-a-recruiter?utm_source=${utmSource}&utm_medium=${utmMedium}&utm_campaign=${utmCampaign}&utm_content=${getNewUtmCon}">Connect with a clinician partner</a>` : `<a class="utm-btn-val-nf" href="https://www.directshifts.com/speak-to-a-recruiter?utm_source=mkt-website&utm_medium=${getMktPageTitle}&utm_campaign=${modifiedTitle}&utm_content=${utmContentDate}">Connect with a clinician partner</a>`;
   ...
   //Search jobs
    jQuery(document).on("click", "datalist input", function () {
        ...
        if(jQuery(this).hasClass('api-occupation')){
            ...
            r = new URL("https://www.directshifts.com/open-jobs-1-feb-2024");
    ...
    jQuery("#clear-all-button").on("click", function () {
        ...
        let a = new URL("https://www.directshifts.com/open-jobs-1-feb-2024");
