                    ...
                    if ("" != e.jobs) {
                        for (let a = 0; a < e.jobs.length; a++) {
                            ...
                            (t += `<tr class="my-code">\n   <td> <div class="jl-title-wrap">\n   <div class="jl-title"><a target="_blank" class="data-link" href="${e.jobs[a].link}">${
                                ...
                                10 === a &&
                                    (t +=
                                        '<tr class="desktopSign cstom2 mobile-apps download-app"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6515046f4f98a9deb8e28fc0_mobile-banner-image.png" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Find your perfect helthcare job on the go with the DirectShifts App!</h4><div class="dirctneq"><ul class="app-list"><li>Application Tracking</li><li>Application Tracking</li><li>Application Tracking</li><li>Application Tracking</li></ul></div><div class="dirctregstrbtn download"><a href="https://play.google.com/store/apps/details?id=com.directshifts&amp;hl=en_US&amp;gl=US">Download Now</a></div></div></div></div></td></tr>');
                        }
                        let a = "";
                        e.total_pages > 1 &&
                            (a =
