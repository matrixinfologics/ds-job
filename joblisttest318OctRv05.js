    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        let specialty_names_str = result.jobs[i].specialty_names;
          ...
          var hotspot_img = '';
          if(hotJobElement){
            hotspot_img = '<div id="hotJob"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b92927905d052de6d4e_Hot%20job.svg"><span>${hotJobElement}</span></div>';
          }
          html += `<tr>
            <td>
                `+hotspot_img+`
