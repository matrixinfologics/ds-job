              ...
              success: function (e) {
                  ...
                  if ("" != e.jobs) {
                      for (let a = 0; a < e.jobs.length; a++) {
                          ...
                          var hotJob = `${e.jobs[a].hot}`;
                          
                          if ( hotJob == 'true' ) {
                             var getText = $('#hotJob').text('Hot Job');
                             console.log(getText);
                          } else {
                            var noText = $('#hotJob').text('');
                            console.log(noText);
                          }
                         (t += `<tr class="my-code">\n <td><div id="hotJob"></div><div class="jl-title-wrap"> <div class="jl-title"><a target="_blank" class="data-link" href="${e.jobs[a].link}">${
                              e.jobs[a].title
                              ...
                              e.jobs[a].state_code
                          }</span></div><div class="jl-location shift-${e.jobs[a].shift_type}"><span>${e.jobs[a].shift_type} Shift</span> </div><div class="jl-location shift-${e.jobs[a].hours_per_shift}"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b92415a74cf87e280c9_Hours%20per%20shifts.svg"/> <span>${e.jobs[a].hours_per_shift} Hours Per Shift</span> </div><div class="jl-location cat-${e.jobs[a].category}"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b9503ed3515087c48d6_Job%20category.svg"/> <span>${e.jobs[a].category}</span> </div><div class="jl-location tagPracticType"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/652d3b97cd50b343566cede6_Practice%20type.svg"/> <span>${
                              "string" == typeof e.jobs[a].practice_type ? `<span>${e.jobs[a].practice_type}</span>` : l }</div></div></div><div class="apply-now-wrap">` + 
