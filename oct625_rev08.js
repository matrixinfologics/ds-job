...
//   Search jobs
    ...
    jQuery(document).on("click", "datalist input", function () {
        ...
        if (t != undefined && t.length) r.searchParams.set("state[]", t.join(","));
        if (s != undefined && s.length) r.searchParams.set("city[]", s.join(","));
        if (i != undefined && i.length) r.searchParams.set("occupation[]", i.join(","));
        if (n != undefined && n.length) r.searchParams.set("specialty[]", n.join(","));
        if (l != undefined && l.length) r.searchParams.set("category[]", l.join(","));
        if (c != undefined && c.length) r.searchParams.set("practice_type[]", c.join(","));
