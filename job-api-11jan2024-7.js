    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        jQuery(document).ready(function () {
            ...
            // Check if the occupation is Physician (MD/DO)
            if (occupationValue === 'Physician+%28MD%2FDO%29') {
                // Show data specific to Physician (MD/DO)
                $('#result').html('<p>Show Physician (MD/DO) data here.</p>');
            } else {
                // Show default data
