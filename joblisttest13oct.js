                      ...
                      for (let a = 0; a < e.jobs.length; a++) {
                         ...
                         (t += `<tr class="my-code">\n   <td> <div class="jl-title-wrap">\n   <div class="jl-title"><a target="_blank" class="data-link" href="${e.jobs[a].link}">${
                          ...
                          `<a target="_blank" class="btn-applynow" href="${e.jobs[a].link}">Apply Now</a></div></div>\n   <div class="jl-types"> <a target="_blank" class="data-link" href="${
                              ...
                              4 === a &&
                                  (t +=
                                      '<tr class="desktopSign cstom1 mobile-apps-1"><td colspan="2"><div class="main-content-b"><div class="image-block"><img src="https://uploads-ssl.webflow.com/5abebcf1b3e0cb4bb9718bba/6528d4f538c315ff9443fa72_Sign%20Up%20Banner%20(1).svg" alt="image"></div><div class="right-content"><div class="directshift_regstring"><h4>Make the most of Directshifts by registering for free</h4><div class="dirctneq"><ul><li>Personalised recommendations</li><li>Get support at every step</li><li>Real-time updates</li><li>Boost visibility with employers</li></ul></div><div class="dirctregstrbtn"><a href="/sign-up">Register Now</a></div></div></div></div></td></tr>'),
                              10 === a &&
                                  (t +=
